...
To install the Dell Pro AI Studio CLI, you can use **Winget** (Windows Package Manager):

```bash
winget install Dell.DPAIS
```

Alternatively, download the MSI installer manually from [here](https://dell.hf.co) and follow the setup prompts.
